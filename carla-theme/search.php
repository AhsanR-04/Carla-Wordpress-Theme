...
<header class="page-header py-5 bg-body-tertiary mb-4">
		<h1 class="page-title text-center">
			...
			printf( esc_html__( 'Search Results for: %s', 'pls-snu' ), '<span>' . get_search_query() . '</span>' );
			?>
		</h1>
</header><!-- .page-header -->
		...
		<div class="row">
				<?php if ( have_posts() ) : ?>
					...
					<div class="py-5 text-center">
						<p><?php esc_html_e( 'No content found. Please try again with some different keywords.', 'pls-snu' ); ?></p>
