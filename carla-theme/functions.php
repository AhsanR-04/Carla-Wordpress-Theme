<?php
/**
 * pls-snu functions and definitions
 *
...
// 	wp_enqueue_style('general-style',  get_theme_file_uri() . '/assets/css/general.css', array() , true);

// 	if ( is_home() || is_front_page()  ) 
// 	{
// 		wp_enqueue_style('home-style',  get_theme_file_uri() . '/assets/css/home.css', array() , true);
...
function defer_parsing_of_js( $url ) {
	if ( FALSE === strpos( $url, '.js' ) ) return $url; // Skip non-JS files
	if ( is_admin() ) return $url; // Don't break WP Admin
	return str_replace( ' src', ' defer src', $url ); // Add defer attribute
 }
